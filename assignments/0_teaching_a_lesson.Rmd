...
1 Week before lesson  | [Submit rough draft lesson plan](https://erwhite1.github.io/QuantReasoning/assignments/0_BackwardDesignTemplate.html) | 4 points
...
If you would like additional resources on backwards design and active learning, here are a few of my favorites:

- [Backward Design introduction](https://cft.vanderbilt.edu/guides-sub-pages/understanding-by-design/)
- [Flipping the classroom](https://cft.vanderbilt.edu/guides-sub-pages/flipping-the-classroom/)
- [Active learning introduction](https://cft.vanderbilt.edu/guides-sub-pages/active-learning/)
- [Ecology and evolution specific](https://cpb.ucdavis.edu/news/resources-teaching-ecology-and-evolution)